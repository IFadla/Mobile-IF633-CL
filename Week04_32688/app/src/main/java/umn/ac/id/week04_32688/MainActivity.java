...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btnKirim, btnBrowse, btnActivityTiga, btnActivityEmpat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnActivityTiga = findViewById(R.id.activityTiga);
        btnActivityEmpat = findViewById(R.id.activityEmpat);
        ...
        btnActivityTiga.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this, ActivityTiga.class));
            }
        });

        btnActivityEmpat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this, ActivityEmpat.class));
            }
        });
    }
